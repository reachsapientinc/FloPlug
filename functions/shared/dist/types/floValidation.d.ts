...
export declare function buildFloValidationReport(issues: FloValidationIssue[], nodeSnapshots: FloNodeValidationSnapshot[], meta?: {
    floId?: string;
    floName?: string;
}): FloValidationReport;
export declare function summarizeValidation(report: FloValidationReport): {
    errorCount: number;
    warningCount: number;
    nodeCount: number;
};
